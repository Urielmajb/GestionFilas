...
<head>
    ...
    <title>Inicio de Sesion - Sistema de Gestión de Filas</title>
                                            ...
                                            <nav aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    <li class="breadcrumb-item">
                                                        <a href="./queue_registration.php"><b>REGISTRO</b></a>
                                                    </li>
                                                    <li class="breadcrumb-item active" aria-current="page">
                                                        <a href="./cashier"><b>ESCRITORIOS</b></a>
                                                    </li>
                                                    <li class="breadcrumb-item active" aria-current="page">
                                                        <a href="./monitoring"><b>MONITOREO</b></a>
                                                    </li>
                                                </ol>
                                            </nav>
                                        </div>
...
<!-- <body class="bg-dark bg-gradient">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h3 class="py-5 text-center text-light">Sistema de Gestion de Filas</h3>
        <div class="card my-3 col-md-4 offset-md-4">
            <div class="card-body">
                <form action="" id="login-form">
                    <center><small>Favor ingresa las credenciales</small></center>
