                                ...
                                <div class="card-body">
                                    <div class="pt-4 pb-2">
                                        <h4 class="card-title text-center pb-0 fs-4">
                                            <b>SISTEMA DE GESTIÓN DE FILAS</b>
                                        </h4>
                                        <p class="text-center">
                                    ...
                                    <form class="row g-3 needs-validation" id="login-form">
                                        ...
                                        <center><small><b>Selecciona un Escritorio a Operar</b></small></center>
                                        <div class="form-group">
                                            ...
                                            <option selected="">Seleccione un Escritorio a Operar</option>
        ...
        <div class="container">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
                ...
                <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">
                    <a href="http://ticket.cancilleria.gob.ni/">INICIO</a>
...
<!-- <body class="bg-dark bg-gradient">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h3 class="py-5 text-center text-light">ESCRITORIO</h3>
        <div class="card my-3 col-md-4 offset-md-4">
            <div class="card-body">
                <form action="" id="login-form">
                    <center><small>Favor seleccionar un Escritorio a Operar..</small></center>
                    <div class="form-group">
                        <label for="cashier_id" class="control-label">Escritorio</label>
                        <select name="cashier_id" id="cashier_id" data-placeholder="Favor seleccionar un Escritorio a Operar.." class="custom-select2 select2">
                            <option disabled selected></option>
                            <?php 
                            /*$cashier = $conn->query("SELECT * FROM `cashier_list` where `status` = 1 order by `name` asc");
                            while($row = $cashier->fetchArray()):
                    ...
                    <div class="form-group d-flex w-100 justify-content-between align-items-center">
                        <a href="./../">Admin</a>
                        <button class="btn btn-sm btn-primary rounded-0 my-1">Acceder</button>
                    </div>
                </form>
            </div>
        </div>
