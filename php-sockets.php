...
//$address="ticket.cancilleria.gob.ni";
$address="192.168.17.172";
//$porti = "443";
//$address="localhost";
$porti="2306";
$null = NULL;
...
class _sHandler {
	...
	function doHandshake($received_header,$client_socket_resource, $address, $port) {
		$headers = array();
		$lines = preg_split("/\r\n/", $received_header);
		...
		"WebSocket-Location: wss://$address:$port/demo/shout.php\r\n".
