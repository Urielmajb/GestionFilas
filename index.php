...
<head>
    ...
    <title><?php echo ucwords(str_replace('_',' ',$page)) ?> | Administrador </title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./?page=cashiers">Lista de Escritorios</a>
                    </li>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="./?page=manage_account">Administrar Cuenta</a></li>
                    <li><a class="dropdown-item" href="./Actions.php?a=logout">Salir</a></li>
                </ul>
            </div>
            </div>
        </div>
