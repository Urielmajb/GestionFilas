...
<div class="container fluid">
    <?php if(isset($_GET['success']) && $_GET['success'] == true): ?>
        <div class="alert alert-success alert-dismissible fade show">Su numeró se genero con éxito</div>
    <?php endif; ?>
    ...
    <div id="outprint">
        <div class="row justify-content-end">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                    <center><b><p>Atención al público</p></b></center>
                    ...
                    <div id="datetimefield" class="card-footer w-100  col-auto">
