...
<head>
    ...
    <title>Registro de Numero de Filas</title>
    <!-- <title><?php /*echo ucwords(str_replace('_',' ',$page)) */?> | Registro de Numero de Filas</title> -->
                      ...
                      <div class="card">
                                    ...
                                    <form action="" id="queue-form">
                                        <div class="form-group">
                                            ...
                                            <label for="no_tram" class="control-label text-info">
                                                <b>Número de Trámites a realizar </b>
                                            </label>
                                            <input type="text" id="no_tram" name="no_tram" autofocus
                                                autocomplete="off"
                                                class="form-control form-control-lg rounded-0 border-0 border-bottom"
                                                required>
                                        </div>
                        ...
                        <!-- <div class="card mb-3">
                            <div class="card-header rounded-0">
                                <div class="h5 card-title">Obtener el numero de fila.</div>
                            </div>
                            <div class="card-body rounded-0">
                                <form action="" id="queue-form">
                                    <div class="form-group">
                                        <label for="customer_name" class="control-label text-info">Ingresar el nombre</label>
                                    ...
                                    <div class="form-group text-center my-2">
                                        <button class="btn btn-warning btn-lg btn col-sm-4 rounded-0" type='submit'>
                                        Obtener Numero
                                        </button>
                                    </div>
                                </form>
                    ...
                    $.ajax({
                        ...
                        success:function(resp){
                            if(resp.status == 'success'){
                                uni_modal("Registro de Números","get_queue.php?success=true&id="+resp.id)
