...
<center><button class="btn btn-lg btn-warning w-25" id="start" type="button"><i class="bi bi-play-fill"></i><b>&nbsp; Iniciar Monitor En Vivo</b></button></center>
    ...
    <div class="d-none" id="monitor-holder">
        <div class="row my-0 mx-0">
                ...
                <div class="col-sm-12 shadow h-100">
                    ...
                    <div class="card-body h-100">
                        <div id="serving-list" class="list-group overflow-auto">
                            ...
                            ?>
                            <div class="card list-group-item" data-id="<?php echo $row['cashier_id'] ?>" style="display:none">
            ...
            <div class="card col-md-7 d-flex flex-column justify-content-center align-items-center text-light" id="action-field">
...
<script>
var websocket = new WebSocket("ws://<?php echo $_SERVER['SERVER_NAME'] ?>:2306/php-sockets.php");
// var websocket = new WebSocket("ws://<?php echo $_SERVER['SERVER_NAME'] ?>:2306/ticketmoni/php-sockets.php"); 
